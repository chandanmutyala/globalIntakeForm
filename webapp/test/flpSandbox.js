		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#globalintakeform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"globalintakeform-display": {
								"semanticObject": "globalintakeform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=globalintakeform",
									"url": sap.ui.require.toUrl("globalintakeform")
								}
							}
						}
					}
